...
/**
 * Listens for Canal {@code CINDEX} (index creation) events.
 * <p>
 * A composed alias for {@link OnCanalEvent} that fixes the event type to
 * {@link CanalEntry.EventType#CINDEX}. Apply it to a method of a
 * {@link com.alibaba.otter.canal.annotation.CanalEventHandler}-annotated bean to
 * receive index-create events for the matching destination/schema/table.
 * </p>
 *
...
/**
 * <p>Auto-configuration for OnCreateIndexEvent.</p>
 * @author <a href="https://github.com/loong10k">Loong Wan</a>
 * @since 1.0.0
 */
