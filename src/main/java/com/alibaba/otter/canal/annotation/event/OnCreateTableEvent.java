...
/**
 * Listens for Canal {@code CREATE} (table creation) events.
 * <p>
 * A composed alias for {@link OnCanalEvent} that fixes the event type to
 * {@link CanalEntry.EventType#CREATE}. Apply it to a method of a
 * {@link com.alibaba.otter.canal.annotation.CanalEventHandler}-annotated bean to
 * receive table-create events for the matching destination/schema.
 * </p>
 *
...
/**
 * <p>Auto-configuration for OnCreateTableEvent.</p>
 * @author <a href="https://github.com/loong10k">Loong Wan</a>
 * @since 1.0.0
 */
