...
/**
 * Spring Boot auto-configuration for the Canal <strong>Kafka</strong> client.
 * <p>
 * Activated when {@code canal.mode=kafka} and consumes Canal binlog events
 * published to Kafka topics via {@code KafkaCanalConnector} instances wired into
 * a {@link KafkaCanalClient}. Registers a {@link RowDataHandler}, an async or
 * sync flat-message {@link MessageHandler} based on {@code canal.async}, and the
 * Spring-managed client bean.
 * </p>
 *
 * <h3>Configuration keys</h3>
 * <ul>
 *   <li>{@code canal.mode} — must be {@code kafka}</li>
...
/**
 * <p>Auto-configuration for CanalKafkaClientAutoConfiguration.</p>
 * @author <a href="https://github.com/loong10k">Loong Wan</a>
 * @since 1.0.0
 */
public class CanalKafkaClientAutoConfiguration {
    ...
    /**
     * Creates the {@link KafkaCanalClient} and registers it with Spring-managed
     ...
     * declared under {@code canal.kafka.instances}.</p>
     *
     * @param connectorProvider    provider of Spring-managed {@code KafkaCanalConnector} beans
     ...
     * @param connectorProperties  Kafka-mode connector configuration providing additional instances
     * @return the started Canal Kafka client
     */
    ...
    public KafkaCanalClient kafkaCanalClient(ObjectProvider<KafkaCanalConnector> connectorProvider,
        ...
        // 1. Collect every Spring-managed KafkaCanalConnector in the context.
        ...
        // 3. Build and return the KafkaCanalClient.
