...
/**
 * Spring Boot auto-configuration for the Canal <strong>RabbitMQ</strong> client.
 * <p>
 * Activated when {@code canal.mode=rabbitmq} and consumes Canal binlog events
 * published to RabbitMQ queues via {@code RabbitMQCanalConnector} instances
 * wired into a {@link RabbitMQCanalClient}. Registers a {@link RowDataHandler},
 ...
 * <ul>
 *   <li>{@code canal.mode} — must be {@code rabbitmq}</li>
...
/**
 * <p>Auto-configuration for CanalRabbitmqClientAutoConfiguration.</p>
 * @author <a href="https://github.com/loong10k">Loong Wan</a>
 * @since 1.0.0
 */
public class CanalRabbitmqClientAutoConfiguration {
	...
	/**
	 * Creates the {@link RabbitMQCanalClient} and registers it with Spring-managed
	 ...
	 * declared under {@code canal.rabbitmq.instances}.</p>
	 *
	 * @param connectorProvider    provider of Spring-managed {@code RabbitMQCanalConnector} beans
	 ...
	 * @param connectorProperties  RabbitMQ-mode connector configuration providing additional instances
	 * @return the started Canal RabbitMQ client
	 */
	...
	public RabbitMQCanalClient rabbitMQCanalClient(ObjectProvider<RabbitMQCanalConnector> connectorProvider,
		...
		// 1. Collect every Spring-managed RabbitMQCanalConnector in the context.
		...
		// 3. Build and return the RabbitMQCanalClient.
